    ...
    >
      ...
      <div className="mb-16 max-w-3xl mx-auto">
        <p className="text-lg mb-6 text-slate-700 dark:text-slate-300">
          <span className="font-semibold text-emerald-600 dark:text-emerald-400">Nur Bilgi</span>, İslami bilgi ve kaynaklara kolay erişim sağlamak amacıyla kurulmuş bir platformdur. 
          Amacımız, dini bilgileri doğru kaynaklardan alarak toplumun her kesimine ulaştırmak ve İslam dininin temel kaynaklarını herkesin anlayabileceği bir şekilde sunmaktır.
        </p>
        
        <p className="text-lg mb-6 text-slate-700 dark:text-slate-300">
          Platformumuzda Kur'an-ı Kerim, hadis kitapları, namaz vakitleri, dualar ve daha birçok İslami kaynak bulunmaktadır. 
          Ayrıca yapay zeka destekli chatbot aracılığıyla dini sorularınıza anında cevap alabilirsiniz.
        </p>
        
        <p className="text-lg text-slate-700 dark:text-slate-300">
          Nur Bilgi ekibi olarak, İslami bilgilerin doğru bir şekilde aktarılması ve yaygınlaştırılması için çalışmalarımızı sürdürüyoruz. 
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
        ...
        <div className="bg-white dark:bg-slate-800 p-8 rounded-xl shadow-lg">
          <h2 className="text-2xl font-bold mb-8 text-emerald-700 dark:text-emerald-400">
            İletişim Bilgileri
          </h2>
          ...
          <div className="space-y-6">
            <div className="flex items-start">
              ...
              <div>
                ...
                <p className="text-slate-600 dark:text-slate-300">iletisim@nurbilgi.com</p>
              </div>
            </div>
            ...
            <div className="flex items-start">
              ...
              <div>
                ...
                <p className="text-slate-600 dark:text-slate-300">+90 (212) 123 45 67</p>
              </div>
            </div>
          ...
          <div className="mt-10">
            ...
            <div className="flex space-x-4">
              <a href="#" className="w-10 h-10 flex items-center justify-center bg-emerald-100 dark:bg-emerald-900 text-emerald-600 dark:text-emerald-400 rounded-full hover:bg-emerald-200 dark:hover:bg-emerald-800 transition-colors">
